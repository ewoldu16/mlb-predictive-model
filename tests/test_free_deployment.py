...
def test_actions_workflow_is_scheduled_manual_cached_and_secret_safe():
 ...
 for required in ('workflow_dispatch:','schedule:','actions/cache/restore@v4','actions/cache/save@v4','github_actions_refresh.py','secrets.SUPABASE_DATABASE_URL'):assert required in text
